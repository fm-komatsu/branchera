...
// 担当者向けの送信元アドレス上書き
$_COM_FROM_MAIL_TANTO = 'brc-coating@haseko.co.jp';
...
if (HTTP_HOST === "www.haseko.co.jp") {
	// 本番環境 TODO:正しい設定
	$_TO_TANTO_EMAIL[] = 'brc-coating@haseko.co.jp';
	$_TO_TANTO_EMAIL[] = 'brc-coating@w-20rxgr3hr14v09yj0bkpj7koq6zw78f00qcglkych20oz7xg9z.2v-1dgl2eai.ap13.case.salesforce.com';
} else {
	// ステージング
	...
	$_TO_TANTO_EMAIL[] = 'brc-coating@zgn00pm3mzmbpoat1tzv336udxi4xmg0scmeg2r1abmw9h5eg.0l-2h66eae.cs58.case.sandbox.salesforce.com';
}

//内部向けメール
//$to_email = $_TO_TANTO_EMAIL[0];
	...
	<article>
		...
		<header class="MainHead">
			<div class="MainHead-inner">
				...
				<h1 class="MainHead-ttl">ハウスコーティング</h1>
			</div>
		</header>
		...
		<div id="container">
			<div id="cont">
				...
				<p>このたびは、ハウスコーティングにお申込みいただきまして、誠にありがとうございます。ご登録いただいたメールアドレスに<b>「自動返信メール」</b>をお送りいたしましたのでご確認ください。</p>
