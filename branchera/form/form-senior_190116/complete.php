...
$item_array = array("hasekoid", "name", "name2", "postal-code", "address-level1", "tel","tel2", "email","email2", "order_how", "types", "search", "area_string", "areaNameText", "contact_memo");
...
if ($_SERVER["HTTP_HOST"] === "www.haseko.co.jp") {
	...
	$_TO_TANTO_EMAIL[1] = 'salespub@haseko-senior.co.jp';
} else {
	// ステージング
