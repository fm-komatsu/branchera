...
$item_array = array(
	"hikkoshi-year", "hikkoshi-month", "hikkoshi-day"
	, "mitsumori-year", "mitsumori-month", "mitsumori-day"
	, "hikkoshi-type", "hikkoshi-amount", "hikkoshi-madori"
	, "new-postal-code", "new-address"
	, "hasekoid", "name", "name2", "postal-code", "address-level1"
	, "tel", "tel2", "email", "email2"
	, "order_how", "contact_memo"
);
...
if (HTTP_HOST === "www.haseko.co.jp") {
	// 本番環境 TODO:正しい設定
	$_TO_TANTO_EMAIL[] = 'art-kantocall@the0123.com';
} else {
	// ステージング
