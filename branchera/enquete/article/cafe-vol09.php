			...
			<section class="main__item">
				...
				<div class="enquete-ex">
					<div class="enquete-ex__row">
						<div class="enquete-ex__ex mb3">
							...
							<p>いつもおうちのキレイを保つために、整理・整頓・収納は大切です。どうやったら効率的にストレスなくこなせるか、お悩みの方も多いはず。片付けが得意な方も苦手な方も、あなたのお家の収納問題の今をお聞きします。</p>
						</div>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						...
						<dl>
							<dt>受付期間</dt>
							<dd>2021年3月25日（木）～3月31日（水）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd><strong>長谷工IDをお持ちの方で、新築マンション入居から5年以内の方</strong></dd>
						</dl>
						<dl>
							<dt>特典</dt>
				...
				<div class="u-btn-layout">
					<div class="u-btn-layout__row">
						<a href="https://haseko.flpjp.com/spiralUrl/BRC024" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div>
				<?php } else { ?>
