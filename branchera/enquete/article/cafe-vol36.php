...
$imakura_enqttl="これからどうなる？テレワーク";

$imakura_info ="コロナ禍で「やむを得ず」「仕方なく」始まったテレワーク。でも慣れとともに、仕事のスタイルもだいぶ変わってきたのではないでしょうか。この2年間でどのような変化があったのか、お聞かせください！";

$imakura_period="2022年5月11日（水）～2022年5月18日（水）";

$imakura_target="長谷工IDをお持ちで、テレワーク（在宅勤務）をされている方、経験されたことのある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/47";
