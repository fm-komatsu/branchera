  ...
  <article class="main__row ">
    ...
    <div class="main__wrapper">
      <section class="main__item">
        <h2 class="u-ttl__l">第15回会員さまアンケートを実施させていただきます。</h2>
        ...
        <div class="enquete-ex">
          <div class="enquete-ex__row">
            <div class="enquete-ex__ex">
              ...
              <p>今回は「室内リフォームに関するアンケート」です。奮ってご回答ください。</p>
        ...
        <div class="u-btn-layout">
          <div class="u-btn-layout__row">
            <a href="https://haseko.flpjp.com/spiralUrl/BRC012" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
          </div>
        </div>
        <?php } else { ?>
