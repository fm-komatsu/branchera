...
$imakura_enqttl="リフォームした今、ハッピーですか？";

$imakura_info ="マンション暮らしをもっと快適にするための一つの選択肢「リフォーム」。入居した頃と家族構成が変わったり、ちょっと気になる部分が見つかったり…思い切ってリフォームをご経験された方に「リフォームは我が家をこんな風に変えました！」というエピソードをお聞かせください。";

$imakura_period="2021年10月14日（木）～2021年10月20日（水）";

$imakura_target="長谷工IDをお持ちの方で、マンションにお住まいのリフォームした経験のある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/19";
