			...
			<section class="main__item">
				...
				<div class="enquete-ex">
					<div class="enquete-ex__row">
						<div class="enquete-ex__ex mb3">
							...
							<p>幅広い年代のご夫婦にお聞きする“千差万別”ご夫婦のあり方。ふたりだけの時間をどのように作りどう過ごしているのか、同じ趣味をもっていたり、逆に違う世界の楽しみを共有することがふれあいの時間だったり、さまざまなご夫婦の今をお聞きします。</p>
						</div>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						<dl>
							<dt>タイトル</dt>
							<dd>「夫婦の時間、大切にしていますか？」</dd>
						</dl>
						<dl>
							<dt>受付期間</dt>
							<dd>2021年1月28日（木）～2月3日（水）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd><strong>長谷工IDをお持ちの、30代～60代のご夫婦</strong></dd>
						</dl>
						<dl>
							<dt>特典</dt>
				...
				<div class="u-btn-layout">
					<div class="u-btn-layout__row">
						<a href="https://haseko.flpjp.com/spiralUrl/BRC021" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div>
				<?php } else { ?>
