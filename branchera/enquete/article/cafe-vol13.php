...
$imakura_enqttl="テレワーク、上手にしてますか？";

$imakura_info ="半年前にスタートした“いま暮らCaf&eacute;”。その第1回は「テレワークと私の暮らし」というテーマで、みなさまから寄せられた声を記事にしました。そして今、このワークスタイルが日常となり、これからも当たり前になっていくと感じている方も多いのではないでしょうか。そんなみなさまの「今」の声をお聞かせください。";

$imakura_period="2021年5月20日（木）～2021年5月26日（水）";

$imakura_target="長谷工IDをお持ちの方で、テレワーク（在宅勤務）を経験されたことのある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/6";
