  ...
  <article class="main__row">
    ...
    <div class="main__wrapper">
      <section class="main__item">
        <h2 class="u-ttl__l">第2回会員さまアンケートを実施させていただきます。</h2>
        ...
        <div class="u-assist">
          ...
          <div class="u-list__dl_table">
            ...
            <dl>
              <dt>特典</dt>
              <dd>回答いただいた方全員に100スマイルプレゼント<br><span class="cap">※スマイルの付与はアンケート期間終了から1週間程度とさせていただきます。また、複数回ご回答いただいた場合でも付与スマイルは100とさせていただきます。</span></dd>
            </dl>
            <dl>
              <dt>回答方法</dt>
