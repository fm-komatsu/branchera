...
$imakura_enqttl="リフォームをやってみてわかったこと";

$imakura_info ="おうち時間が長くなっているということで、注目が集まっているリフォーム。「わたしのリフォーム、ここがお気に入りポイント」や「ぜひ伝えたい、失敗しないコツ」など、実体験に基づいたお声をお聞かせください！";

$imakura_period="2022年6月29日（水）～2022年7月6日（水）";

$imakura_target="長谷工IDをお持ちで、ご自宅のリフォームの経験がある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/51";
