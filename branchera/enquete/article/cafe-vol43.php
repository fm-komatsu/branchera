...
$imakura_enqttl = "機器にも“適齢期”があるんです！《換気扇 編》";

$imakura_info = "わかりづらい住宅設備機器の買い替え時。壊れてからの交換では遅いこともあるので早めにご確認を！今回は、キッチンの「換気扇」にスポットを当ててみなさんの気になることをお聞きします。";

$imakura_period = "2022年9月28日（水）～2022年10月5日（水）";

$imakura_target = "長谷工IDをお持ちで、お家の設備機器が古い方、機器の不調が気になる方";

$imakura_url = "https://haseko.flpjp.com/enquete/3/60";
