			...
			<section class="main__item">
				...
				<div class="enquete-ex">
					<div class="enquete-ex__row">
						<div class="enquete-ex__ex mb3">
							...
							<p>最近、テレワークなどでマンション内の「気のなること」「トラブル」で増えてきているのが“音”です。多くの方が隣り合って生活する上でどうしても気になる音や、音に関する対策、ご自身の体験などについて聞かせてください。</p>
						</div>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						<dl>
							<dt>タイトル</dt>
							<dd>「ちょっと気になる“音”の悩み、教えて！」</dd>
						</dl>
						<dl>
							<dt>受付期間</dt>
							<dd>2021年4月22日（木）～2021年4月28日（水）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd><strong>長谷工IDをお持ちのマンションにお住まいで、隣近所からの“音”や自宅の“音”のトラブルを心配されている方</strong></dd>
						</dl>
						<dl>
							<dt>特典</dt>
				...
				<div class="u-btn-layout">
					<div class="u-btn-layout__row">
						<a href="https://haseko.flpjp.com/enquete/3/4" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div>
				<?php } else { ?>
