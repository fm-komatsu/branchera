...
$imakura_enqttl="みんなどうしてる？結露の対策";

$imakura_info ="冬の悩みごとのひとつ「結露」。みなさんはどの場所での発生が気になって、どのように対処していますか？ご自宅の結露について考えつつ、正しい知識や有効な対処など冬を快適に過ごすコツをつかんでいきましょう。";

$imakura_period="2021年12月9日（木）～2021年12月15日（水）";

$imakura_target="長谷工IDをお持ちの方で、結露でお悩みの方";

$imakura_url="https://haseko.flpjp.com/enquete/3/30";
