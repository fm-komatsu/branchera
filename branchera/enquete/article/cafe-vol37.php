...
$imakura_enqttl="ボーっと使っちゃいけません！SNSの利用は？";

$imakura_info ="スマートフォンの普及で、今や私たちの生活に欠かせないものとなったSNS(ソーシャルネットワーキングサービス)。どんなSNSが人気なのか、どんなところにメリット・デメリットを感じているのかなど、みなさんの利用状況を伺い、SNSの使い方について考えていきたいと思います。";

$imakura_period="2022年5月25日（水）～2022年6月1日（水）";

$imakura_target="長谷工IDをお持ちで、SNSを1つでも利用している方";

$imakura_url="https://haseko.flpjp.com/enquete/3/49";
