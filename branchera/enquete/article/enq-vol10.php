	...
	<article class="main__row ">
		...
		<div class="main__wrapper">
			<section class="main__item">
				<h2 class="u-ttl__l">第10回会員さまアンケートを実施させていただきます。</h2>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						<dl>
							<dt>受付期間</dt>
							<dd>2019年4月1日（月）～2019年4月14日（日）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd>長谷工IDをお持ちの方</dd>
        ...
        <div class="u-btn-layout">
					<div class="u-btn-layout__row">
						<a href="https://haseko.flpjp.com/spiralUrl/BRC006" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div>
        <?php } else { ?>
