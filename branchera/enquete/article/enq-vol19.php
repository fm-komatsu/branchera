  ...
  <article class="main__row ">
    ...
    <div class="main__wrapper">
      <section class="main__item">
        <h2 class="u-ttl__l">第19回会員さまアンケートを実施させていただきます。</h2>
        ...
        <div class="enquete-ex">
          <div class="enquete-ex__row">
            <div class="enquete-ex__ex">
              ...
              <p>今回は「マンションの共用部に関するアンケート」です。<br>“マンションの共用部”とは、駐車場や宅配ボックスなど、そのマンションに住んでいる、みなさんが使用できる設備、施設のことです。<br>マンションにお住まいの方も、そうでない方も、奮ってご回答ください。</p>
        ...
        <div class="u-btn-layout">
          <div class="u-btn-layout__row">
            <a href="https://haseko.flpjp.com/enquete/2/12" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
          </div>
        </div>
        <?php } else { ?>
