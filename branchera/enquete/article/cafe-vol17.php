...
$imakura_enqttl="ハザードマップ、見たことありますか？";

$imakura_info ="いつ何時発生するかわからない自然災害。怖い思いをした時だけ、防災用品や避難場所などの確認をするものの、喉元過ぎれば･･･の方も多いのでは。お住まいの地域のハザードマップには、たくさんの防災情報や示唆が詰まっています。ハザードマップについてどんな意識をお持ちか、お聞かせください。";

$imakura_period="2021年7月15日（木）～2021年7月21日（水）";

$imakura_target="長谷工IDをお持ちの方で、これまで何らか、自然災害の被害に遭われたことのある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/13";
