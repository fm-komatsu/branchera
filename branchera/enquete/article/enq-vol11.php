	...
	<article class="main__row ">
		...
		<div class="main__wrapper">
			<section class="main__item">
				<h2 class="u-ttl__l">第11回会員さまアンケートを実施させていただきます。</h2>
				...
				<div class="enquete-ex">
					<div class="enquete-ex__row">
						<div class="enquete-ex__ex">
							...
							<p>今回は「SNSに関するアンケート」です。奮ってご回答ください。</p>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						<dl>
							<dt>受付期間</dt>
							<dd>2019年7月18日（木）～2019年7月31日（水）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd>長谷工IDをお持ちの方</dd>
        ...
        <div class="u-btn-layout">
					<div class="u-btn-layout__row">
						<a href="https://haseko.flpjp.com/spiralUrl/BRC008" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div>
        <?php } else { ?>
