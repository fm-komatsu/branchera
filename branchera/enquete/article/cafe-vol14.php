...
$imakura_enqttl="お住まいのマンションの資産価値、ご存じですか？";

$imakura_info ="生活スタイルに合わせた住み替えなど、自己所有であっても“終の棲家”と考える方が減ってきているように思います。分譲マンションの場合、売却するとなると気になるのはマンションの資産価値。今のお住まいは資産としてどのくらい価値があるのか、みなさまはご存知ですか？<br>「マンションの資産価値って…？」あなたの思いをお聞かせください。";

$imakura_period="2021年6月3日（木）～2021年6月9日（水）";

$imakura_target="長谷工IDをお持ちの方で、自己所有のマンションにお住まいの方";

$imakura_url="https://haseko.flpjp.com/enquete/3/8";
