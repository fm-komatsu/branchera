	...
	<article class="main__row ">
		...
		<div class="main__wrapper">
			<section class="main__item">
				<h2 class="u-ttl__l">第4回会員さまアンケートを実施させていただきます。</h2>
				...
				<div class="enquete-ex">
					<div class="enquete-ex__row">
						<div class="enquete-ex__ex">
							...
							<p>今回のテーマは「ペット」について。ワンちゃんネコちゃんだけでなく、鳥や虫などを飼われている方も大歓迎。ペットを飼われている方もそうでない方も、奮ってご回答ください。</p>
				...
				<div class="u-assist">
					...
					<div class="u-list__dl_table">
						<dl>
							<dt>受付期間</dt>
							<dd>2017年10月3日（火）～2017年10月12日（木）</dd>
						</dl>
						<dl>
							<dt>対象者</dt>
							<dd>長谷工IDをお持ちの方</dd>
				...
				<!--div class="u-btn-layout mb6">
					<div class="u-btn-layout__row">
						<a href="https://reg31.smp.ne.jp/regist/is?SMPFORM=mhqa-takht-3ee04eaed7eb8a5676cd066117163270" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
					</div>
				</div-->
			</section>
