  ...
  <article class="main__row ">
    ...
    <div class="main__wrapper">
      <section class="main__item">
        <h2 class="u-ttl__l">第23回会員さまアンケートを実施させていただきます。</h2>
        ...
        <?php if ($eventSts == 'new') { ?>
          <div class="u-btn-layout center">
            <div class="u-btn-layout__row">
              <a href="https://haseko.flpjp.com/enquete/2/59" target="_blank" rel="nofollow" class="u-btn_point u-btn-layout__item">アンケートはこちらから</a>
            </div>
          </div>
        <?php } else { ?>
