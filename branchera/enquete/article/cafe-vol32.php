...
$imakura_enqttl="読んで答えて！いま暮ら“読者”感想文";

$imakura_info ="今回は、日頃から「いま暮らCafé」のアンケートに参加し、レポート記事をご覧になっているみなさまのご意見を伺いたいと思います。みなさまとより楽しい「いま暮らCafé」をつくるために、ぜひご回答ください。";

$imakura_period="2022年2月24日（木）～2022年3月2日（水）";

$imakura_target="長谷工IDをお持ちで、いま暮らCaféのアンケートやレポートに関心のある方";

$imakura_url="https://haseko.flpjp.com/enquete/3/40";
      ...
      <section class="main__item">
        ...
        <div class="u-assist">
          ...
          <div class="u-list__dl_table">
            ...
            <dl>
              <dt>特典</dt>
              <dd>ご回答いただいた方全員に100スマイルプレゼント</dd>
            </dl>
            <dl>
              <dt>回答方法</dt>
