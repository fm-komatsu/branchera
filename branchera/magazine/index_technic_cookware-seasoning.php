...
$metaThum = $img_url."/magazine/comic02/technic/tech_cate02@2x.png";
...
<main class="main">
  <article class="main__row">
        ...
        <div class="u-category-title__ex">
          <h2 class="u-category-title__ttl">
            <div>
              ...
              <div class="u-text__palt">今さら聞けない料理のアレコレ</div>
    ...
    <section class="main__item">
      <h3 class="u-ttl__l" id="hocho">調理器具・調味料の基本</h3>
      <div class="recipephotolist__row mb3">
        <?php echo show_event_photoList_2tags("recipe-technic","動画","調理器具・調味料の基本") ?>
      </div>
    </section>
