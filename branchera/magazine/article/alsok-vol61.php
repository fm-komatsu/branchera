      ...
      <section class="main__item">
        ...
        <section class="u-clearfix mb3">
          ...
          <figure class="u-float__right">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img01.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img01@2x.png" alt="<?php echo $pageTtl ?>" style="max-width:180px" class="u-img__max u-only__pc">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img01-sp.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img01-sp@2x.png" alt="<?php echo $pageTtl ?>" style="max-width:156px" class="u-img__max u-only__sp center">
          </figure>
        ...
        <section>
          ...
          <figure class="center mb5">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img02.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img02@2x.png" alt="ひと声から始まる安心感あいさつから始めよう｜<?php echo $pageTtl ?>" style="max-width:423px" class="u-img__max u-only__pc center">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img02-sp.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img02-sp@2x.png" alt="ひと声から始まる安心感あいさつから始めよう｜<?php echo $pageTtl ?>" style="max-width:223px" class="u-img__max u-only__sp center">
          </figure>
        </section>
        <section>
          ...
          <figure class="center mb5">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img03.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img03@2x.png" alt="あいさつをする家族（イメージ）｜<?php echo $pageTtl ?>" style="max-width:479px" class="u-img__max u-only__pc center">
            <img data-src="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img03-sp.png" data-retina="<?php echo $img_url; ?>/magazine/alsok/61/alsok61__img03-sp@2x.png" alt="あいさつをする家族（イメージ）｜<?php echo $pageTtl ?>" style="max-width:241px" class="u-img__max u-only__sp center">
          </figure>
        </section>
