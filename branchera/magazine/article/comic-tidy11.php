	...
	<article class="main__row">
		...
		<section class="comic-pink kaasan">
			<div class="wrapper">
				...
				<p>季節モノの家電は保管の期間が長期になるわね。<br>だから<strong class="red">ホコリがかぶらないような工夫</strong>をしましょう。<br>買ったときにとっておいた箱があればその中に。<br>箱がない場合は大きな袋（不織布）に入れてしまうのもアリよ。<br>段ボールを自分で用意して収納しておくのもOK。<br>ただし、上に何か載せてもつぶれてしまうことがないよう、<br class="u-inly__pc"><strong class="red">新品の段ボールを使う</strong>ようにしましょう。<br>ストーブやファンヒーター、加湿器みたいな家電は<br class="u-inly__pc">扇風機のように分解することはできないから、<br class="u-inly__pc">そのまま収納することになるわね。<br></p>
