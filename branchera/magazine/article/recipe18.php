      ...
      <div class="recipe__design recipe-design">
        <div class="recipe-design__howto mb0">
          ...
          <section>
            ...
            <p class="mb3">ひき肉ベースのカレーなので、ほかの具材を混ぜやすく、手軽にアレンジできます。また、全ての具材を細かく切って使うため、火が通りやすく時短につながります。<br>キーマカレーは水分が少ないので、保存しやすい点も魅力です。多めに作って冷凍したり、翌日のお弁当に使ったりと、幅広く応用できます。</p>
            <div class="mb3">
              <h4>●和風キーマカレー丼</h4>
