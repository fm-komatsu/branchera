...
//キャプチャALTタグ
$altCap01 = 'ボウルに卵を割り入れて、牛乳、塩・こしょうを加えてからよく混ぜます。泡立て過ぎず、卵白が切れる程度に混ぜましょう。';
$altCap02 = 'フライパンを中火にかけて温め、バターを入れます。その後、フライパンを傾けるようにして回し、バターを全体に広げます。';
  ...
  <article class="main__row">
    ...
    <section class="main__wrapper recipe">
      ...
      <div class="recipe__intro recipe-intro">
        <p class="recipe-intro__ex">「うちのご飯は世界イチ」の番外編、お料理の基本をご紹介するミニレッスンへようこそ。<br>第48回は「オムレツの作り方」です。ホテルで出されるような、ふわふわできれいな形のオムレツの作り方をご紹介します。</p>
      </div>
      ...
      <div class="recipe-icn ko_03">
        <div class="inner">
          <p>わ～！フライパンのようせいさんだぁ～！<br>ねえフラッキー！ぼく、ふわふわのオムレツがたべたいなあ～♪</p>
        </div>
      </div>
      <div class="recipe-icn fl_01">
        <div class="inner">
          ...
          <div class="mb4">
            ...
            <div class="mb2">
              ...
              <div class="u-clearfix mb2_sp">
                ...
                <p class="mb2 mb0_sp">ひき肉、ふかしてから潰したじゃがいも、お好みで<a href="<?php echo($base_url)?>/magazine/article/recipe-technic16.php#mijingiri" class="recipe-design__link">みじん切り</a>にした玉ねぎを、フライパンで炒めます。塩・こしょうで味付けをしましょう。</p>
            ...
            <div class="mb2">
              <div>
                ...
                <p class="mb2 mb0_sp">さっとゆでて、一口サイズに切り分けたほうれん草と、ツナをボウルに入れて混ぜ合わせます。塩・こしょうで味付けをしましょう。</p>
            ...
            <div>
              <div>
                ...
                <div class="u-clearfix">
                  ...
                  <p class="mb2 mb0_sp">ボウルに、納豆と刻んだチーズを入れて混ぜ合わせます。納豆パックに付属している醤油を入れてもよいでしょう。</p>
      ...
      <div class="recipe-icn ko_03">
        <div class="inner">
          <p>わーい、オムレツ！<br>このまえテレビでみたやつとおなじだあ！</p>
        </div>
      </div>
      <div class="recipe-icn mama_01">
        <div class="inner">
      ...
      <div class="recipe-icn mama_01">
        <div class="inner">
          <p>ここまで上手に作れたのは、フラッキーのおかげだわ…<br>半信半疑だったけど、これから頼りにさせていただきます！</p>
        </div>
      </div>
      <div class="recipe-icn fl_01">
        <div class="inner">
