			...
			<div class="recipe__design recipe-design">
				<div class="recipe-design__howto mb0">
					...
					<dl class="recipe-design__step mb3">
						...
						<dd class="recipe-design__step_txt"><strong>味に深みを与え、食材に香りを付ける調味料</strong>です。醤油は香りや風味を逃さないため、仕上がり近くに入れます。<br><br>醤油の保存方法は、開栓後は空気に触れると酸化してしまうため、<strong>冷蔵保存</strong>します。<br>※密閉ボトルに入った醤油の場合は、酸化を防ぐ仕組みとなっているため、賞味期限を確認し、常温保存します。</dd>
					</dl>
					...
					<dl class="recipe-design__step mb3">
						...
						<dd class="recipe-design__step_txt"><strong>味をまろやかにし、食材に香りを付ける発酵食品</strong>です。加熱により香りが飛びやすいので、仕上がり近くに入れます。<br><br>保存方法は、空気が入らないように密閉して、<strong>冷蔵保存</strong>します。</dd>
					</dl>
					<div class="recipe-design__check check mb3">
						<div class="check__row">
							<div class="check__ttl">
							...
							<p>「さしすせそ」の「そ」が<a href="<?php echo $base_url ?>/magazine/article/recipe01.php" class="recipe-design__link">味噌</a>、というのはちょっと考え付かないですよね。味噌なら「み」じゃないの？と思う人も多いことでしょう。<br>これにはいくつかの説があり、「そ」はさ行の最後の文字だから下からとったという説がよく挙げられています。ほかにも、味噌の「噌」は日本で作られた漢字なので、この一文字で味噌という意味が通じるから…という説があります。</p>
						</div>
					</div>
					<div class="recipe-design__plus1 plus1 mb3" id="mirin">
						<div class="plus1__row">
							<h3 class="plus1__ttl">酒、みりん、ソースを入れるタイミングとは？</h3>
							<p>味に深みを出すためには、「さしすせそ」以外の調味料が必要な時もありますね。その場合の順番をお教えしましょう。</p>
							<div>
								<div class="mb2">
								...
								<div class="mb2">
									<h4 class="recipe__ttl_s mb0" id="mirin2">みりん</h4>
