...
$metaThum = $img_url."/magazine/comic02/technic/tech_cate04@2x.png";
...
<main class="main">
  <article class="main__row">
    ...
    <section class="main__item">
      <h3 class="u-ttl__l" id="hocho">料理の基本</h3>
      <div class="recipephotolist__row mb3">
        <?php echo show_event_photoList_2tags("recipe-technic","動画","料理の基本") ?>
      </div>
    </section>
