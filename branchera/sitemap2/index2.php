			...
			<div class="sitemap-list__row">
				...
				<div class="sitemap-list__item">
					...
					<ul class="u-list__ul">
						...
						<li class="u-font__palt"><a href="<?php echo $base_url ?>/smile/article/lottery-202109.php">抽選で20名さまに当たる！【長谷工あんしんデリ】たなかみ米 3.6kg</a></li>
						...
						<li><a href="<?php echo $base_url; ?>/smile/article/exchange-twinbird.php">【ツインバード】オーブントースター（レッド）</a></li>
						...
						<li><a href="<?php echo $base_url; ?>/smile/article/exchange-hot_plate.php">【象印】STAN.ホットプレート</a></li>
						<li><a href="<?php echo $base_url; ?>/smile/article/exchange-irobot250.php">【iRobot】床拭きロボット ブラーバ ジェット 250</a></li>
						<li><a href="<?php echo $base_url; ?>/smile/article/exchange-sound.php">【ソニー】グラスサウンドスピーカー</a></li>
					</ul>
				</div>
				<div class="sitemap-list__item">
