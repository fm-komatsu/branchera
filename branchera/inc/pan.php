...
<li class="home"><a href="<?php echo $link_url ?>/" itemprop="url"><span itemprop="title">ブランシエラクラブ ホーム</span></a></li>
<?php
...
?>
<li><a href="<?php echo $no_link ?>" itemprop="url"><span itemprop="title"><?php echo $title?></span></a></li>
</ul>
</div>
