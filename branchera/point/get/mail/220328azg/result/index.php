...
<?php
//meta
$metaTtl = '5スマイル獲得！-長谷工の会員サービス「ブランシエラクラブ」';
$metaDesc = 'おめでとうございます！5スマイル獲得！次回もチャレンジしてね！';
...
<div class="mailpoint">
  ...
  <main class="main mailpoint__main">
    <article class="main__row">
      <?php include ($inc_path."/lib/inc/page/_point/__result.php"); ?>
    </article>
  </main>
