...
//meta
$metaTtl = 'お誕生日おめでとう！100スマイルプレゼント-長谷工の会員サービス「ブランシエラクラブ」';
        ...
        <div class="mailpoint__birth-row">
          <div>
            <div class="mb8 mb6_sp">
              <figure>
                <img src="<?php echo $img_url ?>/point/bd_c1_main@2x.png" alt="Happy birthday to you!! あなたに100スマイルプレゼント！！" class="u-img__max u-only__pc center" style="max-width:740px" loading="lazy">
                <img src="<?php echo $img_url ?>/point/bd_c1_main-sp@2x.png" alt="Happy birthday to you!! あなたに100スマイルプレゼント！！" class="u-img__max u-only__sp center" loading="lazy">
              </figure>
            </div>
