		...
		<section class="main__wrapper">
			...
			<div class="product-img">
				...
				<div class="product-img__row">
					<figure class="product-img__item">
						<a href="http://www.modaencasa.jp/" target="_blank">
							<img
							data-src="../../lib/img/smile/article/list-moda.png"
							data-retina="../../lib/img/smile/article/list-moda@2x.png"
							alt="moda en casa-特別ご優待「20%」"
							width="267"
							height="81"
							style="max-width:267px;">
						</a>
						<figcaption>ヨーロピアンモダンスタイルを提案するライフスタイルショップです。良質でデザイン性が高く、日本の住宅事情のニーズに合わせた機能性に優れたインテリアを展開しています。</figcaption>
					</figure>
					<figure class="product-img__item">
				...
				<div class="lottery-point">
					<div class="lottery-point__row">
						...
						<p>長谷工インテックで取り扱っている30種類以上のブランド家具を、たまったスマイルを使ってご購入いただけます。</p>
				...
				<div class="u-terms">
					...
					<div class="u-terms__row mb2">
						...
						<div class="u-terms__inner">
							...
							<ul class="u-list__ul">
								<li>
									<div>
										...
										<br><small class="u-small">受付/10:30～19:00　※南港ショールーム以外をご希望の方はその旨をお伝えください。</small>
									</div>
								</li>
							...
							<li><div>家具の相談をご希望の方は、「SCALE（スケール）」へ<br>Tel:06-6536-1178　/　Fax:06-6536-1918　/　Adrs:大阪市西区南堀江3-9-9
								<br><small class="u-small">※受付 / 10:00～19：00（水曜定休）</small></div>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="u-btns">
				<div class="u-btns__row">
					<a href="<?php echo $mypoint_url ?>/11" target="_blank" class="u-btn_point">関西圏・東海圏以外の方はこちら</a>
					<a href="<?php echo $mypoint_url ?>/13" target="_blank" class="u-btn_point">関西圏・東海圏の方はこちら</a>
				</div>
			</div>
